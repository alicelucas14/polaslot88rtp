<?php
session_start();
if (!isset($_SESSION['sukseslogin']) || !$_SESSION['sukseslogin']) {
    ...
    <div class="modal fade" id="changepass" tabindex="-1" role="dialog" aria-labelledby="changepasslabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="config/changepass.php">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="changepass_input">New Password (minimum 6 characters)</label>
                        <input id="changepass_input" type="password" name="changepass" class="form-control border border-primary" placeholder="Enter new password..." minlength="6" required>
                    </div>
                </div>
